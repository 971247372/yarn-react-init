 ...
 * @Last modified time: 2017-08-17 10:56:06
 */
...
const publicPath = paths.ensureSlash(env.raw.PUBLIC_URL, true);
  ...
  plugins: [
    ...
    new webpack.DefinePlugin(
      Object.assign(env.stringified, {
        ...
        __DEV__: false,
        VERSION: JSON.stringify(require('../package.json').version + '-' + moment().format('YYMDHm'))
      })
    ),
